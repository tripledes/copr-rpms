...
%changelog
* Fri Dec 18 2020 Johan Kok <johan@fedoraproject.org> - 1.16.0-1
- Bumped to 1.16.0

* Thu Nov 19 2020 Sergi Jimenez <tripledes@fedoraproject.org> - 1.15.1-1
- Bumped to 1.15.1

* Sat Nov 14 2020 Johan Kok <johan@fedoraproject.org> - 1.15.0-1
- Bumped to 1.15.0

* Fri Nov  6 2020 Sergi Jimenez <tripledes@fedoraproject.org> - 1.14.2-1
- Bump to 1.14.2

* Sat Oct 17 2020 Johan Kok <johan@fedoraproject.org> - 1.14.0-1
- Bump to 1.14.0

* Wed Sep 22 2020 Sergi Jimenez <tripledes@fedoraproject.org> - 1.13.1-1
- Bump to 1.13.1

* Wed Aug  5 2020 Sergi Jimenez <tripledes@fedoraproject.org> - 1.12.2-1
- Bump to 1.12.2

* Sun Jul 19 2020 Sergi Jimenez <tripledes@fedoraproject.org> - 1.12.1-1
- Bump to 1.12.1
